...
directed type theory, parametricity, and homotopy type theory.
...
For this reason, all systems for DirTT hitherto developed (to our knowledge), feature one or more of the following internal features to escape this unreasonable requirement:
\begin{itemize}
...
\begin{itemize}
	...
	\item How do we define the Hom-type so that Yoneda is its automatic non-dependent eliminator? Bifibrations, naturality, parametricity. Mention treatment of modal inductive types.
\end{itemize}
}
