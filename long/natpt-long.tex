...
\begin{corollary} \label{thm:boolexp-to-var-assignment}
	For every normal affine expression $e \in \booleanexpr^\#(X)$ that has a leaf $\tilde y \in \accol{y,\lnot y}$ where $y \in X$, there exists a bit assignment $\sigma : X \setminus \accol y \to \accol{0, 1}$ such that $t[\sigma] = \tilde y$. \qed
\end{corollary}
