...
\begin{corollary} \label{thm:jet-cubes-are-jewels}
	For $\myorix \in \accol{\orif, \orifb}$, the functor $\JEP : \jetcube{\myorix}{\mycubex}{M}{\vec a} \to \jetset{\vec a}$ factors over the inclusion $\jetjewel{\vec a} \hookrightarrow \jetset{\vec a}$.
\end{corollary}
\begin{proof}
