...
\begin{definition}
	...
	\begin{enumerate}
		\item We define a pseudofunctor (strict under the strict quotienting \cref{ax:bishop}) $\jetsetsym : \poreshcat \to \Set\Cat$ from the 2-category of polarized reshuffles $\Cat$:
		\begin{itemize}
