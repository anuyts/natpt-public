...
\subsubsection{Semantics on Jet Cuboids and Jet Cubes}
...
\begin{definition}
	\begin{enumerate}
		...
		\item By \cref{thm:backward-jets-equivalent}, we obtain pseudofunctors $\jetcube{\orif}{\affine}{M}{\loch} : \poreshcat\withrr \to \Cat$ and \\
