...
\end{definition}
\begin{corollary}
	The functor $\poldeg(\vec a, \loch)$ (as well as $\poldegeq(\vec a, \loch)$ and $\poldegeqtop(\vec a, \loch)$) respects identity and composition of modalities.
\end{corollary}
\begin{proof}
...
\begin{definition}
	...
	We define a transformation, extranatural in $b$:
	\begin{equation}
		\loch \oriof \loch : \oripsh(b) \times \poldegeqtop(\vec a, b) \to \oridegeqtop(\vec a) : Q \oriof (\pdeg p i) = \odeg{(Q \oriof p)}{i}, \label{eq:ori-of-poldeg}
	\end{equation}
	...
	We can now observe that the action in \cref{eq:ori-of-poldeg} is natural in $\vec a$.
\end{definition}
\todoi{Functoriality/naturality/extranaturality results.}
