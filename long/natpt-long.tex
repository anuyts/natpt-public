...
\begin{corollary} \label{thm:setoid-equiv-set}
	...
	the \emph{setoid-enriched} quotient and discrete functors $\setoidquot : \Setoid \to \setoiddisc_1 \Set$ and $\setoiddisc : \setoiddisc_1 \Set \to \Setoid$ form an equivalence of $\Setoid$-enriched categories (where $\setoiddisc \setoidquot$ is only naturally \emph{equivalent}, not naturally isomorphic, to the identity functor). \qed
\end{corollary}
