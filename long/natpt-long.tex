...
\begin{definition} \label{def:orientation-kit}
	...
	\]
	The set of orientation kits will be denoted $\orientationkit = \accol{\orif, \orife, \orifb, \orifbe}$.
\end{definition}
...
\begin{definition} \label{def:jet-cube-cat}
	Let $\vec a$ be a mask, $\myorix \in \orientationkit$, $\mycubex \in \accol{\affine, \cartes}$ and $M$ a monad on $\Set$.
	We define
