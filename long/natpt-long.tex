...
\begin{proof}
	...
	\begin{enumerate}
		...
		\begin{description}
			\item[$i' = i$] Then we have $p' \ll p$, which by \cref{def:precede-polarity} implies that either $p' = \mixpol\pmrhom{a_i}{b_{\predeg(j)}}$ or $p = \isopol\pmrhom{a_i}{\ypolar}$.
			\begin{itemize}
				\item If $a_i = \npolar$, then we have $p = p' = \nonpol\pmrny$.
				Then we have
				\[
					\equijetsym_j\pmry \oriof \mu = \equijetsym\pmry \oriof \nonpol_i\pmrny = \edgesym_i\pmrn, \qquad
					\infrajetsym_{\predeg(j)}\pmr{b_{\predeg(j)}} \oriof \mu = \infrajetsym\pmr{b_{\predeg(j)}} \oriof \nonpol_i\pmrhom{\npolar}{b_{\predeg(j)}} = \edgesym_i\pmrn,
				\]
				...
				Then we have
				\[
					\equijetsym_j\pmry \oriof \mu = \equijetsym\pmry \oriof \isopol\pmryy = \infrajetsym\pmry, \qquad
					\infrajetsym_{\predeg(j)}\pmr{b_{\predeg(j)}} \oriof \mu = \infrajetsym\pmr{b_{\predeg(j)}} \oriof {p'_i}\pmrhom{\ypolar}{b_{\predeg(j)}} = \infrajetsym\pmry,
				\]
				because $p' \neq \mixpol$. This concludes the proof.
			\end{itemize}
			
			
			\item[$i' = \predeg(i)$]
			\todoi{Old proof} Then by \cref{eq:poresh-withrr-crit2,eq:poresh-withr-crit2}, we find that $p \in \accol{\pospol, \negpol}$. By \cref{eq:poresh-withr-crit2}, $p' \in \accol{\pospol, \negpol, \isopol}$.
