...
\begin{proof}[Proof of equivalence]
	\begin{description}
		...
		\item[$1 \Rightarrow 6$] Condition 1 implies $p \leq q$ because $\jetsym \oriof \loch$ is an isomorphism of posets. If $p \leq q$ but neither is symmetric, then $p = q \in \accol{\pospol \pmryy \neq \negpol \pmryy}$, contradicting 1.
