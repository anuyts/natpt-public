...
\begin{proof}
	...
	\end{itemize}
	The various prism functor multiply the carrier with $\accol{0, 1}$ and thus lift over $\EP$ to the affine/cartesian cube category by multiplying with $(\dm i : \IX)$.
...
\end{proof}
\begin{proposition}
	The involution $\Op_i : \jetset{\vec a} \to \jetset{\vec a}$ lifts to an involution $\Opcube_i : \trijetcubeopt{\eps}{M}{\vec a} \to \trijetcubeopt{\eps}{M}{\vec a}$ which turns around the last arrow of degree $i$.
\end{proposition}
\begin{proof}
