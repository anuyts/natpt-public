...
\begin{proof}
	...
	\begin{itemize}
		...
		\item The first half of the path is sent to $0$, the second half is sent to $1$. Then $\dm i \psub \vfi = \dm j_n' = \_ \mathrel K \dm j_n'$.
...
\begin{lemma} \label{thm:char-jet-cube-to-line}
	...
	\[
		\dm i \psub{\vfi} = h_n(h_{n-1}(\ldots h_3(h_2(h_1(\lnot^{p_1} \dm j_1) \mathrel{R_1} \lnot^{p_2} \dm j_2) \mathrel{R_2} \lnot^{p_3} \dm j_3) \ldots ) \mathrel{R_{n-1}} \lnot^{p_n} \dm j_n)
	\]
