...
\begin{definition} \label{def:jet-cube-cat}
	...
	as the full subcategory of $\cubecat^\eps_M \times_\Set \jetset{\vec a}$ on (forward/trioriented) jet cubes, as justified by \cref{thm:jet-cube-pullback}.
...
\]
Such morphisms are not assumed in the definition of pro-arrow equipments,\todo{Rephrase, this is unclear} so we wish to exclude these.
