...
\end{definition}
\begin{notation} \label{not:jet-polarmode-annotation}
	...
	For this reason, we will sometimes annotate the jet relation with the relevant polarmode: $\jet_i^{a_i}$.
...
\begin{definition} \label{def:sym-closure-of-sym}
	...
	Again, we may annotate these functors with the relevant polarmode: $\UFsym_i^{b_i}$ and $\UCsym_i^{b_i}$.
\end{definition}
