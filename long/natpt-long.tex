...
\end{definition}
\begin{corollary}
	$\Degeqtop$ is a profunctor from $\poreshcat$ to $\polcat$, i.e.\ a 2-functor $\Degeqtop : \poreshcat\op \times \polcat \to \Poset$.
\end{corollary}
We do not have the same result for $\Deg$, and do not bother for $\Degeq$.
\begin{proof}
...
\end{definition}
\todoi{Reintroduce sequence notation for modalities.}
