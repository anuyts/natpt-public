...
That is:
\begin{itemize}
	\item $\jtset\withrr$ and $\jtset\withlr$ will get a common generalization $\jtset\withr$ with domain $\poreshcat\withr$,
	\item $\jtset\withlr$ and $\jtset\withll$ will get a common generalization $\jtset\withl$ with domain $\poreshcat\withl$.
\end{itemize}
...
\begin{proposition} \label{thm:poresh-sin:cohesion}
	...
	\footnote{We do not actually have any use for $\cohdisc^\Sin$.}
