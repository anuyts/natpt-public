...
\begin{definition} \label{def:orientation-psh}
	...
	\[
		\polsymbol(a) = \accol{\equijetsym, \jetsym, \tejsym, \infrajetsym},
	\]
	...
	The action on morphisms $\polsymbol(p)$ is denoted as $\loch \circ p$ and given in \cref{fig:polarity-orientation}; it is monotonically increasing in both arguments.\footnote{So the domain of $\orisymbol$ has reversed 1-cells but not reversed 2-cells / inequalities.}
\end{definition}
\begin{figure}
	\[
