...
%			& \text{($\jetsym \oriof \loch$ is an isomorphism)} \\
		...
		\begin{itemize}
			...
			\todoi{It is sufficient to prove this for $c = \ypolar$, since there is just one composition table for polarities (\cref{fig:polarity-orientation}) and no additional equalities are introduced if the codomain $c$ becomes $\npolar$.}
