...
%	\]
	\[
		\inferencel{conn-abs-tgt:concursor}{
			P \in \accol{\jet, \tej, \equijet} \\
			(Q, \opA) \in \accol{(\jet, \vee), (\tej, \wedge)} \\
			%Q \in \accol{\jet, \tej} \\
			\sez \vfi : (\UFsymcube_j U, V) \to W \\
			\sez (\vfi, t / \dm i) : (U, V) \to \Opcube_j (W, \dm i : \rival{Q_i})
		}{
			\sez (\vfi, \dm j \opA t / \dm i) : (U, \dm j : \rival{P_j}, V) \to (W, \dm i : \rival{Q_i})
		}{$\booleanalg$}
	\]
	\[
		\inferencel{conj:fwd}{
