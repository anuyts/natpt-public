...
\begin{definition} \label{def:prism}
	...
	\begin{itemize}
		...
		\item jet relations generated by:
		\begin{itemize}
			\item $(0, \loch) : \Op_i(X) \to X \multip \rival{\jet_i}$ is a jet set morphism,
			\item $(1, \loch) : X \to X \multip \rival{\jet_i}$ is a jet set morphism,
		\end{itemize}
	\end{itemize}
\end{definition}
