...
The main point worth remarking upon is that the behaviour of $t$ only matters when the other operand does \emph{not} reduce to the absorbing element of the connection at hand.
