...
%	Before that, we put, if existent, the sole variable $\dm k_2$ such that $e_{\dm k_2}$ mentions the second to last variable of degree $i$ in $V$. Etc.
	...
	\begin{itemize}
		...
		\todoi{Lemma: When a variable of the domain is used at a lower degree in the codomain, or not at all, then all variables of the same degree to its left can be promoted to equijet variables. Proof: weaken the codomain over all variables of lower degree.}
