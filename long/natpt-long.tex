...
In \cref{sec:jetcubes:def}, we define a family of \emph{jet cube} categories $\jetcube{\myorix}{\mycubex}{M}{\vec a}$ furthermore parametrized by a mask $\vec a$ and a choice $\myorix \in \accol{\orif, \orifbe}$ of orientation: forward or trioriented.
...
\begin{definition}
	An \textbf{orientation set} is one of the following sets of formal symbols:
	\[
