	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\begin{align}
				...
				&\text{for all } j \in \Degeq(\vec b) \text{ with } j \cdot \lambda = p_i \pmrhom{a_i}{b_j}, \text{the polarity $p$ has a right adjoint}.
...
\begin{proof}
	...
	\end{align*}
	\todoi{This last step is weird, I think we can instead land at $\getdeg(\predeg(\top) \cdot \kappa) = \predeg(\top)$.}
