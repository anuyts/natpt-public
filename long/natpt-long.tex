...
As \cref{def:cat-enriched-graph} already foreboded, we have to make an abhorrent constatation, which however will resolve itself when we specialize to jet cubes\todo{Right?}:
\begin{proposition}
