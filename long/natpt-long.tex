	...
	\begin{enumerate}
		...
		\begin{itemize}
			...
			\begin{align*}
				...
				&= \tejsym \cdot \max \set{P'_i}{P'_i \in \orisymbol(\vec a) \text{ with } P'_i \cdot \rho \leq \jetsym_j} \\
				& \qquad \qquad \text{(Definition of $\ell$)} \\
				&= \max \set{\tejsym \cdot P'_i}{P'_i \in \orisymbol(\vec a) \text{ with } P'_i \cdot \rho \leq \jetsym_j} \\
				& \qquad \qquad \text{(Involution $\tejsym \cdot \loch$ is a lattice isomorphism.)} \\
				&= \max \set{P_i \in \orisymbol(\vec a)}{(\tejsym \cdot P_i) \cdot \rho = \tejsym \cdot (P_i \cdot \rho) \leq \jetsym_j} \\
				& \qquad \qquad \text{(By taking $P'_i := \tejsym \cdot P_i$)} \\
				&= \max \set{P_i \in \orisymbol(\vec a)}{P_i \cdot \rho \leq \tejsym_j} \\
				...
				& \qquad \qquad \text{(Involution $\tejsym \cdot \loch$ preserves and reflects $\leq$.)} \\
				&= \max \set{\tejsym \cdot P'_i}{P'_i \in \orisymbol(\vec a) \text{ with } P'_i \cdot \rho \leq \jetsym_j} \\
				& \qquad \qquad \text{($P'_i := \tejsym \cdot P_i$)} \\
				&= \tejsym \cdot \max \set{P'_i}{P'_i \in \orisymbol(\vec a) \text{ with } P'_i \cdot \rho \leq \jetsym_j} \\
				& \qquad \qquad \text{(Involution $\tejsym \cdot \loch$ is a lattice isomorphism.)} \\
				&= \tejsym \cdot \ell(\jetsym_j) = \tejsym \cdot (\jetsym_j \cdot \lambda) = \tejsym_j \cdot \lambda. \\
				& \qquad \qquad \text{(Definition of $\ell$, of $\lambda$ and of bind.)} \\
				% ------------------------
				\ell(\equijetsym_j)
