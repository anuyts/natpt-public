...
\section{Semantics on Jet Topes and Jet Topical Sets} \label{sec:poresh-jettope}

\subsection{Semantics on Jet Topes}
\todoi{You don't need multiple modalities if they ultimately do the same thing. So consider only those with a right adjoint.}
\todoi{Modalities with a right adjoint, preserve topes iff they have a further right adjoint.}

\subsection{Triple Semantics on Jet Topic Sets}

\subsection{Mask Enhancement}
\todoi{Endofunctor on $\poreshcat$}

\subsection{Strict Semantics on Enhanced Bimodal Jet Topic Setoids}

\subsection{Pseudosemantics on Jet Topic Sets}

\section{Semantics on Jet Cubes and Jet Cubical Sets} \label{sec:poresh-jetcube}

\subsection{Semantics on Jet Cubes}

\subsection{Triple Semantics on Jet Cubical Sets}
\todoi{No go theorem}

\subsection{Mask Enhancement}
\todoi{Endofunctor on $\poreshcat$}

\subsection{Strict Semantics on Enhanced Modal Jet Cubical Sets}

\subsection{Pseudosemantics on Jet Cubical Sets}
